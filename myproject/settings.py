...
SECRET_KEY = 'django-insecure-oqc1k11*$i1cl4ghzrqg_yikr9&iiow&vwgu12-2uzjk!=v3e6'
...
TENANT_MODEL = "customers.Client"        # app.Model that stores tenants
TENANT_DOMAIN_MODEL = "customers.Domain" # domain table

ROOT_URLCONF = 'myproject.dashboard_urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_tenant_test_db',
        'USER': 'django_tenant_test_user',
        'PASSWORD': '1toungpass',
        'HOST': 'localhost',
        'PORT': '5432',
    }
